...
<body>
	...
	<nav class="site-header sticky-top py-1"
		...
		<div
			...
			<a class="btn my-2 mx-5 btn-outline-primary active "
				style="color: white;" href="${contextPath}/bot/">Listar Bots</a> <a
			...
			<div class="row justify-content-center mt-3">
				<p>
					<a class="btn btn-success btn-lg mt-4"
						href="${contextPath}/bot/form?page=addBot" role="button">Adicionar
						novo bot</a>
			</div>
		</div>
		<div class="container">
					...
					<div
						...
						<p>
							<a class="btn btn-primary" href="${contextPath}/bot/${bot.id}"
								role="button"><i class="fas fa-eye"></i></a><a
								class="btn btn-info ml-2" href="${contextPath}/bot/${bot.id}"
								role="button"><i class="fas fa-edit"></i></a><a
								class="btn btn-danger ml-2" href="${contextPath}/bot/${bot.id}"
